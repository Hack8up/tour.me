...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="/enigma/web/plugins/iCheck/flat/blue.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="/enigma/web/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="/enigma/web/home/mailbox"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">12</span></a></li>
    ...
    <!-- Slimscroll -->
    <script src="/enigma/web/plugins/slimScroll/jquery.slimscroll.min.js"></script>
    <!-- FastClick -->
    ...
    <!-- iCheck -->
    <script src="/enigma/web/plugins/iCheck/icheck.min.js"></script>
    <!-- Bootstrap WYSIHTML5 -->
    <script src="/enigma/web/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
    <!-- Page Script -->
    <script>
      $(function () {
        //Add text editor
