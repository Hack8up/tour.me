    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <ol class="breadcrumb">
            <li><a href="/enigma/web/home"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="/enigma/web/home/tours"><i class="fa fa-tags"></i>Tours</li></a>
            <li class="active">Bicol Region</li>
            ...
            <div>
              ...
              <nav class="special-nav">
                <ul>
                  ...
                  <li class="ul-navigation"><a href="/enigma/web/home/culture">Culture</li>
              ...
              <div class="box box-widget">
                <div class='box-header with-border'>
                  <div class='user-block'>
                    ...
                    <span class='username'><a href="#">ALBAY Tourist Group A</a></span>
                ...
                <div class='box-footer box-comments'>
                  <div class='box-comment'>
                    <a href="/enigma/web/home/compose"><button class="btn btn-block btn-success btn-lg">Book me now!</button></a>
                  </div><!-- /.box-comment -->
                </div><!-- /.box-footer -->
              </div><!-- /.box -->
            </div><!-- /.col -->
