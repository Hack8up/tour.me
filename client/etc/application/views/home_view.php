            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  <img class="profile-user-img img-responsive img-circle" src="/enigma/web/dist/img/user2-160x160.jpg" alt="User profile picture">
                  <h3 class="profile-username text-center"><?php echo $fname; ?></h3>
                  <p class="text-muted text-center">Diliman, Quezon City, PH</p>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <strong><i class="fa fa-pencil margin-r-5"></i>Visited:</strong>
                  <p>
                    <span class="label label-danger">Mactan, Cebu</span>
                    <span class="label label-success">La Trinidad, Benguet</span>
                    <span class="label label-info">Tiaong, Quezon</span>
                    <span class="label label-warning">Boracay</span>
                    <span class="label label-primary">Paoay, Ilocos Norte</span>
                  </p>
                    ...
                    <ul class="timeline timeline-inverse">
                      ...
                      <li>
                        ...
                        <div class="timeline-item">
                          ...
                          <h3 class="timeline-header"><a href="#">You visited </a> Paoay, Ilocos Norte</h3>
                      ...
                      <li>
                        ...
                        <div class="timeline-item">
                          ...
                          <h3 class="timeline-header no-border"><a href="#">Ilocos Regional Tour Group</a> accepted your tour request</h3>
                        </div>
                      </li>
                      <!-- END timeline item -->
                      <!-- timeline item -->
                      <li>
                        ...
                        <div class="timeline-item">
                          ...
                          <h3 class="timeline-header"><a href="#">Paoay, Ilocos Norte</a> photos</h3>
                          <div class="timeline-body">
                            <img src="/enigma/web/img/paoay.jpg" alt="..." class="margin">
                          </div>
                        </div>
                      </li>
                      <!-- END timeline item -->
