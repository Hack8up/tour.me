    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="/enigma/web/home/explore">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <h1>Tour by Region</h1>
          <br />
          <div class="row">
            <div class="col-lg-3 col-xs-6"><img src="/enigma/web/img/tiles/tile_car.png" style="height: 200px; width: auto;"></div>
            <div class="col-lg-3 col-xs-6"><img src="/enigma/web/img/tiles/tile_ncr.png" style="height: 200px; width: auto;"></div>
            <div class="col-lg-3 col-xs-6"><img src="/enigma/web/img/tiles/tile_1.png" style="height: 200px; width: auto;"></div>
            <div class="col-lg-3 col-xs-6"><img src="/enigma/web/img/tiles/tile_2.png" style="height: 200px; width: auto;"></div>
          </div>
          <br />
          <div class="row">
          ...
          <br />
          <div class="row">
            <div class="col-lg-3 col-xs-6"><img src="/enigma/web/img/tiles/tile_6.png" style="height: 200px; width: auto;"></div>
            <div class="col-lg-3 col-xs-6"><img src="/enigma/web/img/tiles/tile_7.png" style="height: 200px; width: auto;"></div>
            <div class="col-lg-3 col-xs-6"><img src="/enigma/web/img/tiles/tile_8.png" style="height: 200px; width: auto;"></div>
            <div class="col-lg-3 col-xs-6"><img src="/enigma/web/img/tiles/tile_nir.png" style="height: 200px; width: auto;"></div>
          </div>
          <br />
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
